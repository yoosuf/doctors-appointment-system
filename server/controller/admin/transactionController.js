...
const getTransactionCount = async (req, res) => {
  try {
    ...
    let result = await dbService.countDocument(Transaction, where);
    if (result) {
      result = { totalRecords: result };
      return utils.successResponse(result, res);
    }
...
const getTransactionByAggregate = async (req, res) => {
  try {
...
const bulkInsertTransaction = async (req, res) => {
  try {
    ...
    if (req.body.data !== undefined && req.body.data.length) {
      data = req.body.data;
      let result = await dbService.bulkInsert(Transaction, data);
      return utils.successResponse(result, res);
    } else {
...
const bulkUpdateTransaction = async (req, res) => {
  try {
    ...
    if (req.body.data !== undefined) {
      data = req.body.data;
      let result = await dbService.bulkUpdate(Transaction, filter, data);
      if (!result) {
        return utils.failureResponse("something is wrong.", res);
      }
      return utils.successResponse(result, res);
