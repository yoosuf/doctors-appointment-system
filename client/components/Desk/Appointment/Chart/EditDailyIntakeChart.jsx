...
import useUpdateDailyIntake from '@/components/Desk/Appointment/hooks/useUpdateDailyIntake'
...
const EditDailyIntakeChart = ({ appointmentDetail, clearDailyIntakeData, listAllChart }) => {
                ...
                <div className='flex flex-col h-full shadow-xl bg-primary'>
                  ...
                  <div className='relative flex-1 modal-body '>
                    ...
                    <div className='p-5'>
                      ...
                      {/* SI, Shoulders, Wrist, Ankles, Kemps, SLR, Cervical compression */}
                      ...
                      <div className='grid items-center grid-cols-12 gap-3 mt-3'>
                        <div className='col-span-12 md:col-span-6'>
                          <AsyncSelect
                            ...
                            value={viewableOptions.find(el => el.value === viewableBy)}
                            filterOption={() => true}
                            onChange={data => {
...
export default React.memo(EditDailyIntakeChart)