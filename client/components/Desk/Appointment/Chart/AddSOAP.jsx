...
import useAddSOAP from '@/components/Desk/Appointment/hooks/useAddSOAP'
                          ...
                          <div className='flex items-center justify-center md:justify-end'>
                            <span className='flex items-center chart-profile'>
                              <Avatar
                                ...
                                size={`h-6 w-6`}
                              />
                              <span className='ml-3'>{`${patientId?.firstName} ${patientId?.lastName}`}</span>
                            </span>
                          </div>
                        </div>
                          ...
                          <div className='grid w-full grid-cols-1 gap-3 sm:grid-cols-2 sm:w-auto'>
                            <div className='sm:w-48'>
                              <AsyncSelect
                                ...
                                value={
                                  JSON.stringify(selectedViewable) === '{}'
                                    ? null
                                    : selectedViewable
                                }
