...
import useCancelAppointment from '@/components/Desk/Appointment/hooks/useCancelAppointment';
import { TextareaField } from '@/components/AppUi/Form/TextareaField';

const CancelAppointment = ({ isOpen, closeModal, closeParentModel,  appointmentDetail }) => {

    const { formik } = useCancelAppointment(closeModal, appointmentDetail, closeParentModel);
