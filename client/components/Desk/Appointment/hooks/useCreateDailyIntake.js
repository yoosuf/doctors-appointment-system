...
const useCreateDailyIntake = ({ appointmentDetail, listAllChart }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      // console.log(`CREATOR ID `, getRole()?.creatorId)
...
export default useCreateDailyIntake