...
export const PatientPopover = ({ patientId }) => {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <Popover className="relative z-50"> {/* Increase z-index here */}
      <Popover.Button 
      ...
      {isOpen && (
        <Popover.Panel 
          className="absolute z-50 mt-2 overflow-hidden transition-all bg-white rounded-lg shadow-lg w-52" 
          onMouseEnter={() => setIsOpen(true)}
          onMouseLeave={() => setIsOpen(false)}
        >
