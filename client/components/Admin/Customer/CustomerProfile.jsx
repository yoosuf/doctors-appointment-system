...
import UserManagementImageProfile from './ImageProfile'
          ...
          <div className='grid gap-5 mt-5 lg:grid-cols-2'>
            <div className=''>
              ...
              <div className='grid grid-cols-2 gap-8 p-4 mt-4 last-activity bg-primary rounded-xl h-fit'>
                <div className='heading'>
                  <h3 className='mb-5 font-semibold'>Referral information</h3>
                  ...
                  <div className=''>
                    <div className='mt-3'>
                      ...
                      {refferalInformation?.aboutUs?.map(desc => (
                        <p className='mt-1 text-sm text-gray-400'>
                          {desc?.name}
                        </p>
                      ))}
