...
import FileUploadComponent from '@/widget/ImageUpload/FileUploadComponenent'
import Loader from '@/widget/loader'
import useCustomerAddFile from '@/components/Admin/Customer/hooks/useCustomerAddFile'

export default function AddCustomerFile(props) {
  const {
    loading,
    closeBtn,
    formik,
  ...
  } = useCustomerAddFile(props)

  return (
    <>
      <form onSubmit={formik.handleSubmit}>
        <section
          id='AddCustomerFileModal'
            ...
            <div className='fixed inset-y-0 right-0 flex max-w-full activity-modal'>
              <div className='w-screen max-w-xl'>
                <div className='flex flex-col h-full shadow-xl bg-primary'>
                  ...
                  <div className='relative p-4 modal-body' id='top-div-file'>
                        ...
                        <div className='grid grid-cols-1 gap-3 mt-3 sm:grid-cols-1'>
                          <div>
                            <Select
                              ...
                              formik={formik}
                              loadOptions={loadOptionsServiceCatgory}
                            />
                    ...
                    <div className='grid gap-2 pb-4 mt-4 border-b border-gray-700 md:grid-cols-12'>
                      ...
                      <div className='col-span-9'>
                        <FileUploadComponent
                          ...
                          type={fileTypeValue}
                          text='Upload file'
                          text1='or drag and drop'
                          text2='PNG, JPG, PDF, DOC'
                          svg={
                            <svg
