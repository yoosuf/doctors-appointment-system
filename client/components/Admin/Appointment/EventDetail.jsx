...
const EventDetail = ({
  ...
  return (
    <>
      <section
        id='eventDetailCalendarViewModal'
                    ...
                    <div className='mt-4 event-text'>
                      ...
                      <div className='mt-6'>
                        ...
                        <p className='text-gray-400'>
                          {event.locationId?.locationAddressId?.addressLine1 +
                            ',' +
                            event.locationId?.locationAddressId?.addressLine2}
                        </p>
                        <p className='text-gray-400'>
                          {event.locationId?.locationAddressId?.cityId?.name +
                            ', ' +
                            event.locationId?.locationAddressId?.provinceId
                              ?.name +
                            ', ' +
                            event.locationId?.locationAddressId?.postalCodeId
                              ?.postalCode}
                        </p>
                        <p className='text-gray-400'>
                          {event.locationId?.locationAddressId?.countryId?.name}
                        </p>
                      </div>
                      <div className='mt-8'>
