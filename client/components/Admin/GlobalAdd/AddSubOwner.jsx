...
import useAddSubOwner from '@/components/Admin/hooks/useAddSubOwner'
                        ...
                        <div className='grid grid-cols-12 gap-4'>
                          ...
                          <div className='col-span-12'>
                            <AsyncSelect
                              styles={customStyles}
                              value={
                                JSON.stringify(selectedOwnerValue) === '{}'
                                  ? null
                                  : selectedOwnerValue
                              }
                              isSearchable
                              ...
                              id='parentId'
                              defaultOptions={ownerOptionsData}
                        ...
                        <div className='grid grid-cols-12 gap-4'>
                          <div className='col-span-12 form-group'>
                            <AsyncSelect
                              ...
                              isDisabled={ownerId ? false : true}
                              // filterOption={() => true}
                              onChange={data => {
                                formik.setFieldValue('locationId', data?.value)
                                if (data === null) {
                                  setSelectedLocationValue({})
                                } else {
...
export default React.memo(AddSubOwner)
