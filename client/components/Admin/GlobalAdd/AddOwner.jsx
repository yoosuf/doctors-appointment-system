...
import useAddOwner from '@/components/Admin/hooks/useAddOwner'
...
import { REQUIRED_IMAGE_TYPE, CHECK } from '@/utils/constant'
...
const AddOwner = props => {
  ...
  const genderOptionData = genderOptionsData

  const newGenerData = genderOptionData.filter(item => item.label !== CHECK)
                          ...
                          <div className='col-span-12 form-group'>
                            <AsyncSelect
                              ...
                              onChange={async data => {
                                ...
                                formik.setFieldValue('locationId', arr)
                                if (data) {
