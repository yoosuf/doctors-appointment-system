...
import BillingColumn from '@/widget/react-table/BillingColumn'
...
const ManageOwnerBilling = () => {
  const listData = [
    {
      orderId: 'INV2552',
      date: '6/5/2020',
      orderDetail: 'Multi Purchase',
    ...
    },
    {
      ...
      status: (
        <Link href='#'>
          <a className='px-3 py-1 text-xs font-medium text-gray-900 bg-red-500 rounded-full'>
            Payment failed
          </a>
        </Link>
      ),
    },
    {
      ...
      status: (
        <Link href='#'>
          <a className='px-3 py-1 text-xs font-medium text-gray-900 rounded-full bg-yellowBg'>
            pending
          </a>
        </Link>
      ),
  ...
  return (
    <>
      <div className='flex flex-wrap gap-4 my-5 atm-main'>
        <div className='relative p-5 overflow-hidden rounded-lg atm-card atm1'>
        ...
        <div className='relative p-5 overflow-hidden rounded-lg atm-card atm2'>
          <div className='flex items-center justify-between'>
            <div className=''></div>
            <div className='visa'>
              <svg
        ...
        <div className='flex items-center justify-center border-2 border-dashed rounded-lg add-atm-card bg-primary border-grayLight'>
          <label
            htmlFor='file-upload'
            className='relative text-gray-400 rounded-md cursor-pointer'>
      ...
      <div className='overflow-hidden rounded-lg products bg-primary'>
        <div className='grid grid-cols-12 gap-4 p-4'>
          <div className='col-span-12 xl:col-span-4 lg:col-span-6'>
          ...
          <div className='hidden lg:col-span-2 xl:block'></div>
          <div className='hidden col-span-12 lg:col-span-1 md:col-span-4 sm:col-span-6 xl:block'></div>
          ...
          <div className='col-span-12 lg:col-span-3 md:col-span-4 sm:col-span-6'>
            <div className='grid grid-cols-12'>
              ...
              <div className='w-full col-span-8'>
                <div
                  type='text'
                  className='w-full px-2 py-2.5 bg-transparent border border-gray-700 text-white text-sm h-full text-center'>
                  01 May - 07 May
                </div>
              </div>
              <Link href='#'>
...
export default ManageOwnerBilling
