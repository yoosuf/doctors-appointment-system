...
const useAddNurse = ({
  ...
  const closeBtn = () => {
    ...
    const openAddChrio = document.getElementById('AddNurseModal')
  ...
  const onClickSubmit = async ({ values, nurse }) => {
    setLoading(true)
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      onClickSubmit({ values, nurse: 'NURSE' })
    },
  })
