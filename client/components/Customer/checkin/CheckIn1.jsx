...
import useCheckin from '@/components/Customer/checkin/hooks/useCheckin'
...
export default function CheckIn1() {
  ...
  const onChangePhone = (e) => {
    let { value: oldValue } = formik.getFieldProps('phone');
    ...
    if (value && /^\d+$/.test(value)) {
      ...
      formik.setFieldValue('phone', oldValue)
    }
  }
  ...
  return (
    <>
      {loading && <Loader />}
      <div
       className='flex flex-col p-8 checkin1 checkin-bg'>
          ...
          <section className='items-center justify-between gap-3 py-12 my-auto text-center middle-banner md:flex md:py-3 md:text-left'>
            <div className='mb-8 text-center banner-text md:mb-0 md:text-left'>
              ...
              <SnapCrackButton
                ...
                className='inline-flex items-center gap-2 px-6 py-4 mt-8 font-medium text-center text-black transition rounded-lg bg-yellowBg hover:bg-yellow-400'
