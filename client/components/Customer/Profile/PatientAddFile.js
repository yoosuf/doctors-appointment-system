...
import usePatientAddFile from '@/components/Customer/Profile/hooks/usePatientAddFile'
...
export default function PatientAddFile (props) {
  const {
    loading,
    closeBtn,
    formik,
  ...
  } = usePatientAddFile(props)

  return (
    <>
      <form onSubmit={formik.handleSubmit}>
        <section
          id='AddPatientFileModal'
